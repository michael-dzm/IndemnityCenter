...
public class StopProjectEntryPresenter extends ParentPresenter<StopProjectEntryMvpView> {

    public static final String TAG = StopProjectEntryPresenter.class.getSimpleName();

    @Inject
    public StopProjectEntryPresenter(DataManager dataManager) {
        super(dataManager);
    }
        ...
        mSubscription.add(mDataManager.saveOperate(project, operate, duMultiMedias)
                ...
                .subscribe(new Subscriber<Boolean>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        getMvpView().onSaveError(R.string.text_toast_stop_project_save_failed);
                    }
