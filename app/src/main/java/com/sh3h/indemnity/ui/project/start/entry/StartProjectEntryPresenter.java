...
public class StartProjectEntryPresenter extends ParentPresenter<StartProjectEntryMvpView> {

    private static final String TAG = StartProjectEntryPresenter.class.getName();

    @Inject
    public StartProjectEntryPresenter(DataManager dataManager) {
        super(dataManager);
    }
     ...
     * @param view
     */
    public void onCameraClick(View view, int relateType){
        getMvpView().onTakePhoto(relateType);
    }
        ...
        mSubscription.add(mDataManager.saveOperate(project, operate, duMultiMedias)
                ...
                .subscribe(new Subscriber<Boolean>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        getMvpView().onSaveError(R.string.text_toast_start_project_save_failed);
                    }
