...
import com.sh3h.indemnity.databinding.ActivityRestartProjectBinding;
...
public class RestartProjectActivity extends ParentActivity implements RestartProjectMvpView{

    @Inject
    RestartProjectPresenter mPresenter;

    private DUProject mProject;

    private FragmentManager mFragmentManager;

    private ActivityRestartProjectBinding mBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_restart_project);
        getActivityComponent().inject(this);
        mPresenter.attachView(this);
        mBinding.include.toolbar.setNavigationIcon(R.mipmap.ic_menu_back);
        mBinding.include.toolbar.setTitle(R.string.activity_restart_project);
    ...
    public void onCheckedChanged(int checkedId) {
        ...
        switch (checkedId){
            case R.id.rb_detail:
                ...
                break;
            case R.id.rb_entry:
                RestartProjectEntryFragment entryFragment = (RestartProjectEntryFragment) mFragmentManager.findFragmentByTag(RestartProjectEntryFragment.class.getName());
                if(entryFragment == null){
                    entryFragment = new RestartProjectEntryFragment();
    ...
    private void initFragment(String fragmentName) {
        ...
        if(fragmentName.equals(ProjectDetailFragment.class.getName())){
            ...
            fragment.setArguments(bundle);
            transaction.add(R.id.fragment_container, fragment, fragment.getClass().getName()).commit();
        }else if (fragmentName.equals(RestartProjectEntryFragment.class.getName())){
            RestartProjectEntryFragment fragment = new RestartProjectEntryFragment();
            fragment.setArguments(bundle);
