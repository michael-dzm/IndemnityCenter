...
public class RPCEntity extends StringEntity {
	 ...
	 */
	public RPCEntity(JSONObject jsonObject) throws UnsupportedEncodingException 
	{
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public RPCEntity(JSONObject jsonObject, String encoding) throws UnsupportedEncodingException
	{
